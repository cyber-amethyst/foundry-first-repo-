...
contract FundMe {
    ...
    function cheaperWithdraw() public onlyOwner {
        ...
        for (
            ...
            funderIndex < fundersLength; //This will save gas by avoiding reading s_funders.length on every loop and instead reading it once. funderLenght is now a memory variable
            funderIndex++
        ) {
